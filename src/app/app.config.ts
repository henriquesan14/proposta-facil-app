...
import { BulbOutline, CloseCircleOutline, CloseOutline, DeleteOutline, DollarOutline, EyeOutline, FileDoneOutline, HomeOutline, LockOutline, LogoutOutline, MenuFoldOutline, MenuUnfoldOutline, PauseCircleOutline, PlusCircleOutline, SearchOutline, SendOutline, SettingOutline, UsergroupAddOutline, UserOutline } from '@ant-design/icons-angular/icons';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideNzIcons([UserOutline, LockOutline, MenuFoldOutline, MenuUnfoldOutline, SettingOutline, LogoutOutline, CloseOutline, SearchOutline, PlusCircleOutline, UsergroupAddOutline, FileDoneOutline, CloseCircleOutline, 
      DeleteOutline, SendOutline, LockOutline, HomeOutline, EyeOutline, DollarOutline, BulbOutline, PauseCircleOutline]),
